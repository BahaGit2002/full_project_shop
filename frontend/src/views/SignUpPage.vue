  ...
  <div class="flex w-full">
    <div class="w-full md:w-1/2 p-20 space-y-10">
      ...
      <form @submit="handleSubmit">
        ...
        <input v-model="firstName" type="text" placeholder="First Name" class="w-full p-3 mb-4 border rounded-lg"/>
        <input v-model="lastName" type="text" placeholder="Last Name" class="w-full p-3 mb-4 border rounded-lg"/>
        ...
        <button type="submit" class="w-full bg-blue-600 text-white p-3 rounded-lg mb-4">Sign up</button>
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
          Already have an account? <a href="/sign-in" class="text-blue-600">Sign in</a>
        </p>
      </form>
    </div>
